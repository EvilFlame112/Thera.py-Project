...
def pathget():
    ...
    ent_path.insert(0, os.path.join(file_path1.replace("/","\\"), "Thera"))
                ...
                def wizmain():
                    if ent_adminpwd.get() != "":
                        if ent_reenter.get() != "":
                            ...
                            startdir = winshell.start_menu()
                            start_shortcut_path = os.path.join(startdir, "Programs", "TheraPy Hospital Software.lnk")
                            ...
                            if ent_adminpwd.get() == ent_reenter.get():
                                ...
                                def makedb():
                                    ...
                                    x = (final_win.winfo_screenwidth()/2)-540
...
style.theme_use("azure-dark")
x = (base.winfo_screenwidth()/2)-540
