...
def lgin():
    ...
    if found == False:
        ...
        msgbox_yesnoregister.title("Thera.py v1.0")
        msgbox_yesnoregister.iconbitmap(ico_path)
        x = (msgbox_yesnoregister.winfo_screenwidth()/2)-135
        y = (msgbox_yesnoregister.winfo_screenheight()/2)-65
        msgbox_yesnoregister.geometry(f"270x130+{int(x)}+{int(y)}")
